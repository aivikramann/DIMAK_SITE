        ...
        <div className="border-b border-gray-800 pb-20 mb-20">
            <div className="max-w-4xl">
                ...
                <div className="flex flex-col sm:flex-row gap-6">
                    <a href={`mailto:${CONTACT_INFO.email}`} className="group flex items-center justify-between bg-white text-dimak-darker px-8 py-4 rounded-lg font-bold text-lg hover:bg-dimak-gold transition-colors min-w-[200px]">
                        Start a Project
