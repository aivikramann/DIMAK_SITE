...
const highlights = [
  ...
  { icon: FileSpreadsheet, label: "Accounts and Audit Assurance", delay: 0.4 },
  { icon: Calculator, label: "Taxation Advisory", delay: 0.5 },
  { icon: Gavel, label: "Legal Services", delay: 0.6 },
  { icon: Users, label: "Recruitment and Training", delay: 0.7 },
  { icon: TrendingUp, label: "Operational Excellence", delay: 0.8 },
  { icon: Cpu, label: "IT Services", delay: 0.9 }
];
